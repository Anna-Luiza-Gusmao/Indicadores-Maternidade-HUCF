...
function valorSelecionado(){
    ...
    if(seletorAno.options[seletorAno.selectedIndex].value == "" && seletorMes.options[seletorMes.selectedIndex].value == ""){
        ...
        //Ano 2019
        if (seletorAno.options[seletorAno.selectedIndex].value == "2019" && seletorMes.options[seletorMes.selectedIndex].value == "Todos"){
            $("#todas_tabelas").fadeOut("1900");
            $("#todas_tabelas").fadeIn("2000");
            regulaTamanho();
        }else if (seletorAno.options[seletorAno.selectedIndex].value == "2019" && seletorMes.options[seletorMes.selectedIndex].value == "Janeiro"){
            $("#todas_tabelas").fadeOut("1900");
            $("#todas_tabelas").fadeIn("2000");
            regulaTamanho();
        ...
        //Ano 2020
        if (seletorAno.options[seletorAno.selectedIndex].value == "2020" && seletorMes.options[seletorMes.selectedIndex].value == "Todos"){
            $("#todas_tabelas").fadeOut("1900");
            $("#todas_tabelas").fadeIn("2000");
            regulaTamanho();
        }else if (seletorAno.options[seletorAno.selectedIndex].value == "2020" && seletorMes.options[seletorMes.selectedIndex].value == "Janeiro"){
            $("#todas_tabelas").fadeOut("1900");
            $("#todas_tabelas").fadeIn("2000");
            regulaTamanho();
        ...
        //Ano 2021
        if (seletorAno.options[seletorAno.selectedIndex].value == "2021" && seletorMes.options[seletorMes.selectedIndex].value == "Todos"){
            $("#todas_tabelas").fadeOut("1900");
            $("#todas_tabelas").fadeIn("2000");
            regulaTamanho();
        }else if (seletorAno.options[seletorAno.selectedIndex].value == "2021" && seletorMes.options[seletorMes.selectedIndex].value == "Janeiro"){
            $("#todas_tabelas").fadeOut("1900");
            $("#todas_tabelas").fadeIn("2000");
            regulaTamanho();
        ...
        //Ano 2022
        if (seletorAno.options[seletorAno.selectedIndex].value == "2022" && seletorMes.options[seletorMes.selectedIndex].value == "Todos"){
            $("#todas_tabelas").fadeOut("1900");
            $("#todas_tabelas").fadeIn("2000");
            regulaTamanho();
        }else if (seletorAno.options[seletorAno.selectedIndex].value == "2022" && seletorMes.options[seletorMes.selectedIndex].value == "Janeiro"){
            $("#todas_tabelas").fadeOut("1900");
            $("#todas_tabelas").fadeIn("2000");
            regulaTamanho();
